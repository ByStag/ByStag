...
Bilgisayar Mühendisliği mezunuyum ve frontend geliştirme alanında çalışıyorum. Modern web teknolojileriyle kullanıcı dostu, performanslı ve sürdürülebilir arayüzler geliştirmeye odaklanıyorum. Sürekli öğrenmeyi ve yeni teknolojileri takip etmeyi seviyorum. Özellikle TypeScript tabanlı frontend geliştirme, kullanıcı deneyimi ve modern web mimarileri üzerine çalışmalar yapıyorum.
